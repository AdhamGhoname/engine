...
// Camera 
Camera* camera = new Camera(glm::vec3(0.0f, 0.0f, 3.0f), // position
...
int main()
{
   ...
   // -----------------------------
	...
	// Shader
	Shader simpleDepthShader = Shader("resources/shaders/simpleDepthShader.vertex.glsl", "resources/shaders/simpleDepthShader.frag.glsl");
	Shader debugQuadShader = Shader("resources/shaders/debugQuad.vertex.glsl", "resources/shaders/debugQuad.frag.glsl");
	Shader shader = Shader("resources/shaders/shadowMapping.vertex.glsl", "resources/shaders/shadowMapping.frag.glsl");

	// Textures
	Texture woodTexture = Texture("resources/wood.png");
...
void processInput(GLFWwindow* window)
{
	...
	{
		camera->TranslateRelative(glm::vec3(0.0f, 0.0f, -2.5f) * 1.0f / 200.0f);
	}
	else if (glfwGetKey(window, GLFW_KEY_A))
	{
		camera->TranslateRelative(glm::vec3(-2.5f, 0.0f, 0.0) * 1.0f / 200.0f);
	}
	...
	{
		camera->TranslateRelative(glm::vec3(0.0f, 2.0f, 0.0f) * 1.0f / 200.0f);
	}
